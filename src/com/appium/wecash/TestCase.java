...
public class TestCase {
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("appActivity", ".SplanshActivity");
   ...
   // @AfterTest(alwaysRun=true)
    ...
    public void testcase() {
    	...
    	WebElement e=wait.until(new ExpectedCondition<WebElement>(){
    		...
    		return d.findElement(By.id("com.syqy.wecash:id/start_login"));
    	}
		...
		*/
    	...
    	if(Xlsfile.isempty("wecash_testcase",0, i))
        {break;}
    	WebElement elementname=a.element(driver,Xlsfile.search(Xlsfile.readxls("wecash_testcase",0, i)));
    	String execute=Xlsfile.readxls("wecash_testcase",1, i);
    	String value=Xlsfile.readxls("wecash_testcase",2, i);
